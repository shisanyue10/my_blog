                                        ...
                                        <td height="10" colspan="3" valign="center" bgcolor="#9EF469"><font size="5">查看全部博客文章:</font> </td>
                                            ...
                                            <?php
                                              if ($_GET[page]){
                                                ...
                                                if ($i==1) {
                                                  $sql=mysql_query("select id,title,author,now from tb_article order by id desc limit $offset, $page_size");     
                                                  }
                                             ?>
                                      <tr col>
                            ...
                            <td width="50%" align="right" bgcolor="#9EF469" class="hongse01">
                                    <?php
                                          if($_GET[page]!=1)
                                           ...
                                           echo "<a href=file_more.php?page=".($_GET[page]-1).">上一页&nbsp;&nbsp;&nbsp;</a>&nbsp;";
                                           }
                                          if($_GET[page]<$page_count)
                                           {
                                            echo "<a href=file_more.php?page=".($_GET[page]+1).">下一页&nbsp;&nbsp;&nbsp;</a>&nbsp;";
