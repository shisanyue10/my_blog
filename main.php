						...
						<td height="56" align="left">
							<div class="search radius6">
								<form name="searchform" method="post" action="search.php">
									...
									<input class="inp_srh" name="keyboard" style=""  placeholder="请输入您要搜索的文章" >
							 ...
							 <td height="20" valign="baseline">
							 	<table width="100%"  border="0" cellpadding="0" cellspacing="0">
							 		<tr>
							 			...
							 			<input style="FONT-SIZE: 9pt;width: 60px;background-color:#0ad940 ;border: 0px;"  type="submit" value="登录">&nbsp;
										 				 <?php }else{ ?>
				...
				<table width="100%" height="530"  border="0" cellpadding="0" cellspacing="0" table bgcolor=#def1f5>
					...
					<tr>
					          <td height="522" align="top"><table style="WIDTH: 480px" cellspacing=0 cellpadding=0>
					            <?php 
					              $sql=mysql_query("select id,title,author,now from tb_article order by now desc limit 5");
					              $i=1;
					             ...
					             <?php $i=$i+1; } ?>
					            <tr  align="right">
								  	<td colspan="3" height="30" align="right"><a href="file_more.php"><img src=" images/more.png" width="30" height="30" border="0">&nbsp;&nbsp;&nbsp;<br>more...</a></td>
								</tr>
