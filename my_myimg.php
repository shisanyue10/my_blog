						...
						<td>
							<table>
								<tr style="height: 60px;">
									...
									<td style="width: 100px;"><a style="FONT-SIZE: 17pt; COLOR: #95d974"; href="myimg.php?author=$author">我的相册</a></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
					          <td height="522px" align="top" style="width: 520px;">
					          	<table>
									<tr style="height: 160px;">
										
										<form action="addimg.php" method="post" enctype="multipart/form-data">
											<input type="file" name="file" value="选择图片" style="margin-left: 90px;margin-right: 16px;">
											<input type="submit" value="添加图片" style="background-color: #74d986;border: 0px;height: 28px;">
										</form>
									</tr>
								    ...
								    <tr style="overflow-y:scroll;">
											...
											if ($arr) {
												...
												foreach ($arr as $key => $value) {
													echo "<tr><label style='margin: 30px;'>";
													echo "<img src='".$value['file']."',width='160px' height='160px' style='margin: 10px 80px;'>";
													echo "</label></tr></br>";
												}
